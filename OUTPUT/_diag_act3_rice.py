...
TASKS[48] = dict(
    ...
    prompt=(
        ...
        "Audio: 蝉鸣与风吹稻浪声（后期）；男生缓缓地说：安江农校。一九六一年。"
    ),
)
...
TASKS[57] = dict(
    ...
    ref1=G_ZHANG_YUAN, ref2=SCENE_RICE, dur=3.0,
    prompt=(
...
TASKS[61] = dict(
    ...
    ref1=P_LIU_SICHENG, ref2=SCENE_RICE, dur=2.0,
    prompt=(
        # ★ 2026-09-16 修复（README §6.10）：
...
TASKS[63] = dict(
    ...
    prompt=(
        ...
        "Audio: 蝉鸣、稻浪声（后期）；男生认真地说：袁隆平爷爷。我们是从未来来的。"
    ),
)
