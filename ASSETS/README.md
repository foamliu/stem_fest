...
《如愿·看见》(`storyboard.md`，129 镜号) 的**全部输入素材**放在这里：
...
|:-:|------|------|----------|------------------------|:----:|------------------------------------------|:---------:|
| 01 | 刘思齐 | `01_liu_siqi/liu_siqi_hero_v01.png` | PNG 2048×1152 RGB（横版） | 39,51,109,115,120,123 等（焦点镜全量见 `_cast_per_char.txt`） | **女**（定妆照核对） | 同一位初中女生，黑色中长发扎马尾，细框眼镜，白色短袖 Polo 衫（领口红色装饰），黑色长裤，红领巾 | **1101** |
| 02 | 刘思成 | `02_liu_sicheng/liu_sicheng_hero_v01.png` | PNG 2304×1728 RGB（横版） | 8,18,20,53,81,116,119 等（同上） | **女**（镜 16「学**她**」） | 同一位初中女生，黑色中长发扎马尾，细框眼镜，白色短袖 Polo 衫，黑色长裤，红领巾 | 待填 |
| 03 | 徐畅景 | `03_xu_changjing/xu_changjing_hero_v01.png` | PNG 1536×2048 RGB（**竖版·头肩特写**） | 11,50,79,110,118,122 等（同上） | 未写明（按定妆照） | 同一位初中男生，黑色短发，白色短袖 Polo 衫（红色领边），深色长裤，红领巾（**不戴眼镜**） | 待填 |
| 04 | 张书扬 | `04_zhang_shuyang/zhang_shuyang_hero_v01.png` | PNG 1728×2304 RGB（**竖版**） | 5,6,12,112,114,117,125 等（同上） | 男（镜 25「他」） | 同一位初中男生，黑色短发，白色短袖 Polo 衫，黑色长裤，红领巾（**不戴眼镜**） | 待填 |
| 05 | 黄继光 | **`05_huang_jiguang/huang_jiguang_hero_v02.png`（主·已去水印）** ＋ `hero_v01`（带水印·备查） | PNG 1664×2249（v02）/ 1664×2368（v01） | 38（唯一单人镜）+ 20 个多人镜（同上） | 男（史实） | 同一位男性军人，黑色短发平头，军绿色立领制服（双胸袋配纽扣），军绿色长裤，军帽带红色五角星帽徽，棕色腰带 | 待填 |
| 06 | 袁隆平 | `06_yuan_longping/yuan_longping_hero_v01.png`（主·中山装）＋ `hero_v02`（备选） | PNG 2848×1600（v01）/ 2048×1152（v02） | 50,52,53,60,64,73 等（同上） | 男（史实） | 同一位男性，黑色短发侧分，深灰色立领中山装（双胸袋配纽扣） | 待填 |
| 07 | 钟南山 | `07_zhong_nanshan/zhong_nanshan_hero_v01.png` | PNG 880×1184 RGB（**小图**） | 75,91,104 等（同上） | 男（史实） | 同一位男性，黑白相间短发侧分，细金属框眼镜，深灰格纹西装，白衬衫，蓝几何领带 | 待填 |
...
⇒ 多人镜 **88/129**、去重 **28 种组合**（详见 `README.md` §4.2 与 §8 P0）。
...
| 05 | `05_classroom_night` | 八（1）班教室（夜） | 106-129 | 现实只过了一小会儿 | 深蓝 + 橙红、屏幕光打脸 |
...
> 镜 126-129 无场景图（黑屏字幕 / 三帧静帧 / 定格）；镜 9、124 复用 `03` / `05`。
...
| `CHARACTERS/_group/four_students_hero_v02.png` | 四小强同框镜（9/10/41/76/83/106/111/124/129）｜v01 **❌ 报废**（混脸） | ✅ **已到位**（2026-09-13 用户提供宽幅合影；只裁不修 → 2848×1062） |
