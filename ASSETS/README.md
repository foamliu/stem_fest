...
《如愿·看见》(`storyboard.md`，126 镜号) 的**全部输入素材**放在这里：
...
> 镜 123-124 无场景图（黑屏字幕）；镜 125 三帧静帧、镜 126 定格。镜 9、121 复用 `03` / `05`。
...
> ⚠️ **待人工复核**：`06_rice_grain` 与 `07_mask` 的手部机位本应一致（镜 125 要把两者放一起），
