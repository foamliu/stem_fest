...
《如愿·看见》(`storyboard.md`，127 镜号) 的**全部输入素材**放在这里：
...
|:-:|------|------|----------|------------------------|:----:|------------------------------------------|:---------:|
| 01 | 刘思齐 | `01_liu_siqi/liu_siqi_hero_v01.png` | PNG 2048×1152 RGB（横版） | 全为多人镜；代表镜 20/37/49/113/117/121（全量见 `_cast_per_char.txt`） | **女**（定妆照核对） | 同一位初中女生，黑色中长发扎马尾，细框眼镜，白色短袖 Polo 衫（领口红色装饰），黑色长裤，红领巾 | **1101** |
| 02 | 刘思成 | `02_liu_sicheng/liu_sicheng_hero_v01.png` | PNG 2304×1728 RGB（横版） | **18（唯一单人镜）** + 53 个多人镜（同上） | **女**（镜 16「学**她**」） | 同一位初中女生，黑色中长发扎马尾，细框眼镜，白色短袖 Polo 衫，黑色长裤，红领巾 | 待填 |
| 03 | 徐畅景 | `03_xu_changjing/xu_changjing_hero_v01.png` | PNG 1536×2048 RGB（**竖版·头肩特写**） | 全为多人镜；代表镜 31/32/48/77/120（同上） | 未写明（按定妆照） | 同一位初中男生，黑色短发，白色短袖 Polo 衫（红色领边），深色长裤，红领巾（**不戴眼镜**） | 待填 |
| 04 | 张书扬 | `04_zhang_shuyang/zhang_shuyang_hero_v01.png` | PNG 1728×2304 RGB（**竖版**） | 全为多人镜；代表镜 12/25/30/112/123（同上） | 男（镜 25「他」） | 同一位初中男生，黑色短发，白色短袖 Polo 衫，黑色长裤，红领巾（**不戴眼镜**） | 待填 |
| 05 | 黄继光 | **`05_huang_jiguang/huang_jiguang_hero_v02.png`（主·已去水印）** ＋ `hero_v01`（带水印·备查） | PNG 1664×2249（v02）/ 1664×2368（v01） | 全为多人镜（24/27/29/33/38/40/43/45/46/109），**无单人镜** | 男（史实） | 同一位男性军人，黑色短发平头，军绿色立领制服（双胸袋配纽扣），军绿色长裤，军帽带红色五角星帽徽，棕色腰带 | 待填 |
| 06 | 袁隆平 | `06_yuan_longping/yuan_longping_hero_v01.png`（主·中山装）＋ `hero_v02`（备选） | PNG 2848×1600（v01）/ 2048×1152（v02） | **50,52,53,73（单人镜）** + 多人镜（同上） | 男（史实） | 同一位男性，黑色短发侧分，深灰色立领中山装（双胸袋配纽扣） | 待填 |
| 07 | 钟南山 | `07_zhong_nanshan/zhong_nanshan_hero_v01.png` | PNG 880×1184 RGB（**小图**） | **75,104（单人镜）** + 多人镜（同上） | 男（史实） | 同一位男性，黑白相间短发侧分，细金属框眼镜，深灰格纹西装，白衬衫，蓝几何领带 | 待填 |

> 📋 **「焦点镜」口径说明**：上表每人只列 6-7 个代表镜；**全量出场镜号**（含多人镜）
> 见 `OUTPUT/_cast_per_char.txt`（由 `python OUTPUT/_diag_cast_per_char.py` 生成，每改剧本必重跑）。

> **配角（`CHARACTERS/_extras/`）**：08 小战士（无单人镜，均在多人镜里）、09 五岁小女孩（3）、
> 10 妈妈 + 11 志愿军战士群演（无单人镜）—— 定妆照 2026-09-13 已全部就位。
>
...
⇒ 多人镜 **88/127**、去重 **28 种组合**（详见 `README.md` §4.2 与 §8 P0）。
...
| 05 | `05_classroom_night` | 八（1）班教室（夜） | 106-127 | 现实只过了一小会儿 | 深蓝 + 橙红、屏幕光打脸 |
...
> 镜 126-127 无场景图（黑屏字幕）；镜 128 三帧静帧、镜 129 定格。镜 9、122 复用 `03` / `05`。
...
| `CHARACTERS/_group/four_students_hero_v02.png` | 四小强同框镜（9/10/41/76/83/106/111/122/127）｜v01 **❌ 报废**（混脸） | ✅ **已到位**（2026-09-13 用户提供宽幅合影；只裁不修 → 2848×1062） |
...
| # | 文件 | seed | 备注 |
|:-:|------|:----:|------|
| 01 | `01_paper_plane/paper_plane_hero_v01.png` | 4001 | 全片核心意象（呼应《阿甘正传》羽毛），镜 3-8、124 |
| 02 | `02_holo_device/holo_device_hero_v01.png` | 4002 | 全息设备，镜 10/17/18（启动键） |
| 03 | `03_holo_screen/holo_screen_hero_v01.png` | 4003 | 全息屏（界面文字**故意不可读**），镜 11/120/125 |
| 04 | `04_rice_plant/rice_plant_hero_v01.png` | 4004 | 整株稻（含系布条标记那株），中景用 |
| 05 | `05_rice_ear/rice_ear_detail_v01.png` | 4005 | 稻穗特写，与 04 不要混用 |
| 06 | `06_rice_grain/rice_grain_hero_v01.png` | 4006 | ⚠️ **有手**（符合设计）；掌中谷粒，镜 72/106/118/124/128 |
| 07 | `07_mask/mask_hero_v02.png`（v01 作废） | 4007 → **7001**（LongCat） | ⚠️ **有手**；背景已由**金色稻田**换成**夜间室内深色**（四角亮度 88.8→**55.7**、R−B 67.6→**−15.7**），否则暖调会污染镜 102/103/106/118/124 的夜景 |
